...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     *
     * @param context        the current context
     * @param itemResourceId the resource ID for a layout file containing a TextView to use
     *                       when instantiating items views
     */
    protected AbstractWheelTextAdapter(Context context, int itemResourceId) {
        this(context, itemResourceId, NO_RESOURCE, 0, maxsize, minsize);
    }
     ...
     */
    protected AbstractWheelTextAdapter(Context context, int itemResourceId, int itemTextResource, int currentIndex,
